...
- Orb-it logo (`public/OrbitLogo.png`) appears on Home (next to "Welcome back", 120×120 — up from 80×80, itself doubled from an original 40×40) and on the Annual Report (masthead + footer signature) — in-fiction branding, same convention as the booster decal / Assembly badge / Launch Pad mark.
